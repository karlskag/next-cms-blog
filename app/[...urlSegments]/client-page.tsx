...
export default function PostClientPage(props: ClientPostProps) {
  ...
  return (
    <ErrorBoundary>
      <Section>
        <h2 data-tina-field={tinaField(post, 'title')} className={`w-full relative\tmb-8 text-5xl md:text-6xl font-extrabold tracking-normal text-center title-font`}>
          ...
          <div className='md:px-4 w-full'>
            <div data-tina-field={tinaField(post, 'heroImg')} className='relative max-w-4xl lg:max-w-5xl mx-auto'>
              ...
              <Image
                ...
                width={500}
                height={500}
                className='relative z-10 mb-14 mx-auto block md:rounded-lg w-full h-auto opacity-100'
                style={{ maxWidth: '80vw' }}
              />
            </div>
          </div>
